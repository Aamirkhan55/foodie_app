...
import 'package:foodie_app/screen/main/nav/home/home_category/food/food_detail.dart';
      ...
      child: ListView(
        ...
        children: BURGER_SPECIAL_CATEGORY_LIST.map((specialBurger) {
          return GestureDetector(
            onTap: () {
              Navigator.push(context, MaterialPageRoute(builder: (context) => FoodDetailScreen(data: specialBurger)));
            },
            child: SizedBox(
              width: 300,
              child: Column(
    ...
    return SizedBox(
      ...
      child: ListView(
        ...
        children: PIZZA_SPECIAL_CATEGORY_LIST.map((pizza) {
          return GestureDetector(
            onTap: () {
              Navigator.push(context, MaterialPageRoute(builder: (context) => FoodDetailScreen(data: pizza)));
    ...
    return SizedBox(
      ...
      child: ListView(
        ...
        children: SANDWICH_SPECIAL_CATEGORY_LIST.map((sandwich) {
          return GestureDetector(
            onTap: () {
              Navigator.push(context, MaterialPageRoute(builder: (context) => FoodDetailScreen(data: sandwich)));
    ...
    return SizedBox(
      ...
      child: ListView(
        ...
        children: BURGER_POPULAR_CATEGORY_LIST.map((burger) {
          return GestureDetector(
            onTap: () {
              Navigator.push(context, MaterialPageRoute(builder: (context) => FoodDetailScreen(data: burger)));
                    ...
                    children: [
                      Expanded(
                        child: Padding(
                          ...
                          child: Text("${burger['title']}", overflow: TextOverflow.ellipsis,style: const TextStyle(fontWeight: FontWeight.bold),),
                        ),
                      ),
                      Padding(
                  ...
                  Row(
                    ...
                    children: [
                      Expanded(
                        child: Padding(
                          padding: const EdgeInsets.only(left: 8.0),
                          child: Text("${pizza['title']}", overflow: TextOverflow.ellipsis,style: const TextStyle(fontWeight: FontWeight.bold),),
                        ),
                      ),
                      Padding(
                        padding: const EdgeInsets.only(right: 10.0),
                  ...
                  Row(
                    ...
                    children: [
                      Expanded(
                        child: Padding(
                          padding: const EdgeInsets.only(left: 8.0),
                          child: Text("${sandwich['title']}", overflow: TextOverflow.ellipsis,style: const TextStyle(fontWeight: FontWeight.bold),),
                        ),
                      ),
                      Padding(
                        padding: const EdgeInsets.only(right: 10.0),
